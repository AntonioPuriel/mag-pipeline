...
> 🚧 Work in progress — QC and assembly are implemented; binning and MAG quality assessment are next.
...
| `--min_contig_length` | `1500` | Minimum contig length kept for binning |
